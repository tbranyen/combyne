...
},{"./shared/encode":4,"./shared/map":5,"./shared/register_filter":6,"./shared/register_partial":7,"./support/array/map":9,"./support/array/reduce":10,"./utils/create_object":15,"./utils/type":19}],2:[function(require,module,exports){
'use strict';
...
Combyne.VERSION = '0.7.0';
module.exports = Combyne;
},{"./compiler":1,"./grammar":2,"./shared/register_filter":6,"./shared/register_partial":7,"./tokenizer":13,"./tree":14,"./utils/defaults":16,"./utils/type":19}],4:[function(require,module,exports){
'use strict';
var type = require('../utils/type');
function encode(raw) {
    if (type(raw) !== 'string') {
...
},{"../utils/type":19}],5:[function(require,module,exports){
'use strict';
var type = require('../utils/type');
var createObject = require('../utils/create_object');
...
module.exports = map;
},{"../support/array/is_array":8,"../utils/create_object":15,"../utils/type":19}],6:[function(require,module,exports){
'use strict';
function registerFilter(name, callback) {
    ...
    for (var partialName in this._partials) {
        if (!this._partials.hasOwnProperty(partialName)) {
            continue;
        }
        this._partials[partialName]._filters[name] = this._filters[name];
    }
...
},{"../../utils/type":19}],9:[function(require,module,exports){
'use strict';
...
module.exports = Tree;
},{"./support/string/trim":12,"./utils/parse_property":18}],15:[function(require,module,exports){
'use strict';
