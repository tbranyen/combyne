...
define(function(require, exports, module) {
   ...
   * @param {object} delimiters - The delimiters to be used while parsing.
   */
  ...
  /**
   * Sets the delimiters to be used by the template.
   *
   * @memberOf module:index.Combyne
   * @param {object} delimiters - The delimiters to set.
   */
  Combyne.prototype.setDelimiters = function(delimiters) {
    if (type(delimiters) != "object") {
      throw new Error("Delimiters must be an Object.");
    }

    // Look up from the passed in delimiters or global settings.
    var inherits = function(name) {
      return delimiters[name] || Combyne.settings.delimiters[name];
    };
